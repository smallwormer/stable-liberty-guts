...
class GutsObject(base.VersionedObject):
    ...
    # guts, and other objects can exist on the same bus and be distinguished
    # from one another.
    OBJ_PROJECT_NAMESPACE = 'guts'

    # NOTE(thangp): As more objects are added to guts, each object should
    ...
    def conditional_update(self, values, expected_values=None, filters=(),
        ...
        if save_all:
            changes = self.guts_obj_get_changes()
